namespace NovumPatchServer.Constants;

public static class UpdateMatrix
{
    public static readonly Dictionary<string, string> Bootversion = new()
    {
        { "0", "2010.09.18.0000" },
        { "2010.07.10.0000", "2010.09.18.0000" }
    };

    public static readonly Dictionary<string, string> Gameversion = new()
    {
        { "0", "2010.07.10.0000" },
